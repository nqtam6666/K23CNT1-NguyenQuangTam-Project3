...
public class NqtJwtService {
    ...
    private SecretKey getSigningKey() {
        ...
        String key = secret.length() >= 32 ? secret : secret + "0".repeat(32 - secret.length());
        return Keys.hmacShaKeyFor(key.substring(0, 32).getBytes());
    }

    public String generateToken(String username, Integer userId, Byte role) {
    ...
    public Byte extractRole(String token) {
        Claims claims = extractAllClaims(token);
        return claims.get("role", Byte.class);
    }
